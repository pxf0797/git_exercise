...
* @brief        :组件cufLedUsrCtrl 内部各组成部分错误码定义头文件
* @others       :
...
***********************************************************************************************************************/
#define cufLedUsrCtrl_part1_pi     0                                                                  // 组件部件1
#define cufLedUsrCtrl_part1_err1                           0        // EC_EC_cie       EC_ER_warning  // 组件部件1错误1
/**********************************************************************************************************************/
#define cufLedUsrCtrl_part2_pi     1                                                                  // 组件部件1
#define cufLedUsrCtrl_part2_err1                           0        // EC_EC_cie       EC_ER_warning  // 组件部件1错误1
/**********************************************************************************************************************/
